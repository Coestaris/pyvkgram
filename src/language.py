...
/help - Чтобы вывести эту хелпу""",
            ...
            "server_error" : "Произошла серверная ошибка😢😢",
            "post_header" : u"Posted by *{}* (ID: {})\nat _{}_.\n❤️ {} | 💬 {} | 📢 {}",

            "group_text_reply" : [ 
                "И зачем ты мне прислал эту группу?", 
                "Для постов юзай /getPosts", 
                "Хз что мне делать с этой группой" 
            ],

            "text_reply" : [ 
                "И что мне с этим делать?", 
                "Юзай /help чтобы получить список команд", 
                "Без понятия что ты от меня хочешь", 
                "Прикольно, но что дальше?",
                "Как хорошо, что я не Игорь"]
        }
    }
]
